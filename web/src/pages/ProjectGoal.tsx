  ...
  return (
    <div className="min-h-svh flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-2xl text-center">
        <p className="uppercase tracking-[0.2em] text-xs text-gold font-medium mb-4">Passo 1 de 2</p>
        <h1 className="font-serif text-3xl md:text-4xl text-ink mb-10">Qual é o seu objetivo?</h1>
