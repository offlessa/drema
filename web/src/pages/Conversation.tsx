...
export function Conversation() {
  ...
  return (
    <div className="min-h-svh flex flex-col">
      <AppHeader />
      <div className="flex-1 flex flex-col px-6 py-8 max-w-2xl mx-auto w-full min-h-0">
        ...
        <form onSubmit={handleSubmit} className="flex gap-2 mt-4">
          ...
          />
          <Button type="submit" fullWidth={false} className="px-6" loading={sendMessage.isPending}>
            Enviar
          </Button>
        </form>
      </div>
